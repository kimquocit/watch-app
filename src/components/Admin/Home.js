...
import { Input, FormGroup, Label, Modal, ModalHeader, ModalBody, ModalFooter, Table, Button, Dropdown, DropdownToggle, DropdownMenu, DropdownItem } from 'reactstrap';
      ...
      <div>
        ...
        <div className="App container">
          ...
          <Modal isOpen={this.state.newItemModal} toggle={this.toggleNewItemModal.bind(this)}>
            <ModalHeader toggle={this.toggleNewItemModal.bind(this)}>Add a new book</ModalHeader>
            <ModalBody>
              <FormGroup>
            ...
            <ModalFooter>
              <Button color="primary" onClick={this.addItem.bind(this)}>Add Book</Button>{' '}
              <Button color="primary" onClick={this.toggleNewItemModal.bind(this)}>Cancel</Button>
            </ModalFooter>
          </Modal>
          ...
          <Modal isOpen={this.state.editItemModal} toggle={this.toggleEditItemModal.bind(this)}>
            ...
            <ModalFooter>
              <Button color="primary" onClick={this.updateItem.bind(this)}>Update Book</Button>{' '}
              <Button color="primary" onClick={this.toggleEditItemModal.bind(this)}>Cancel</Button>
            </ModalFooter>
          </Modal>
